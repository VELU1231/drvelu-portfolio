        ...
        <div className="grid grid-cols-1 xl:grid-cols-[1.1fr_1.1fr_0.8fr] gap-5">
          ...
          >
            ...
            <a
              ...
              className="mt-6 inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-white/90 px-4 py-2.5 text-sm font-semibold text-slate-700 hover:border-slate-300"
            >
